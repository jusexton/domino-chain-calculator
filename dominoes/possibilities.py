...
class DominoPossibilities:
    ...
    def all(self):
        ...
        return _all_possible(self.domino_list, self.starting_value, self.include_sum, root_node, root_node)
...
def _all_possible(domino_list: Iterable[Domino], starting_value: int, include_sum: bool, parent: Node,
                  root: Node) -> Node:
